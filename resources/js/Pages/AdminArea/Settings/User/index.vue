<template>
    <AdminLayout>
                    ...
                    <div class="header-body row">
                        ...
                        <div class="col-lg-4 text-right py-4">
                            <button type="button" class="btn btn-primary btn btn-sm btn-neutral" data-toggle="modal"
                                @click.prevent="resetData()" data-target="#newUserModal">
                            ...
                            <div class="flex">
                                ...
                                <div class="items-center text-muted mx-1">
                                    ...
                                    <div class="inline-block" style="width: 200px;">
                                        <Multiselect v-model="select_User_status" :options="statusList"
                                ...
                                <div class="items-center text-muted mx-1">
                                    ...
                                    <div class="inline-block ">
                                        <input type="text" class="form-control form-control-sm" name="User_code"
                                            id="User_code" v-model="User_code" @keyup="getSearch"
                        ...
                        <div class="row mx-4">
                            <div class="table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr v-for="value in UserData" :key="value.id"  >
                                            <td class="textClassBody text-center"  @click.prevent="editUserModal(value)">
                                            ...
                                            <td class="textClassBody"  @click.prevent="editUserModal(value)">
                                                {{ value.email }}
                                            </td>
                                            <td>
                                                <button class="btn btn-sm btn-danger" @click.prevent="deleteUser(value.id)">Delete</button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
        ...
        <template #modals>
            <div class="modal fade" id="newUserModal" data-bs-backdrop="static" tabindex="-1" role="dialog"
                                ...
                                <div class="card-body">
                                    <form role="form text-left" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control form-control-sm" name="last_name"
                                                    id="last_name" placeholder="last name" v-model="User.last_name"
                                                    required />
                                            </div>
                                            <small id="msg_code"
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-9">
                                                <input type="email" class="form-control form-control-sm" name="email"
                                                    id="email" placeholder="email" v-model="User.email" required />
                                    ...
                                    <form role="form text-left" enctype="multipart/form-data">
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control form-control-sm"
                                                    name="first_name" id="name" placeholder="First name"
                                                    v-model="editUser.first_name" required />
                                                <small v-if="validationErrors.first_name" id="first_name"
                                                    class="text-danger form-text text-error-msg error">{{
                                                        validationErrors.first_name }}</small>
                                            </div>
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control form-control-sm" name="last_name"
                                                    id="last_name" placeholder="last name" v-model="editUser.last_name"
                                                    required />
                                            </div>
                                            <small id="msg_code"
                                                class="text-danger form-text text-error-msg error"></small>
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-9">
                                                <input type="email" class="form-control form-control-sm" name="email"
                                                    id="email" placeholder="email" v-model="editUser.email" required />
                                                <small v-if="validationErrors.email" id="email"
                                                    class="text-danger form-text text-error-msg error">{{
                                                        validationErrors.email }}</small>
                                            </div>
...
const User_code = ref(null);
const first_name = ref(null);
const last_name = ref(null);
const email = ref(null);
const select_User_status = ref([]);
...
const updateUser = async () => {
    try {
        const response = await axios.post(
            route("admin.user.update", editUser.value.id),
            editUser.value
        )
            .then((response) => {
                Swal.fire({
...
const deleteUser = async (id) => {
    try {
        const response = await axios
            .delete(route("admin.user.delete", id))
            .then((response) => {
                Swal.fire({
                    icon: "success",
                    title: "Success",
...
const reload = async () => {
    try {
        const response = (
            await axios.get(route("admin.user.all"), {
                params: {
                    page: page.value,
                    per_page: pageCount.value,
                    status: select_User_status.value?.id,
